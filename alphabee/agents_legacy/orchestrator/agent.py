...
from alphabee.agents_legacy.orchestrator.prompts import ALPHABEE_SYSTEM_PROMPT
...
from alphabee.agents_legacy.industry.agent import industry_agent_factory
