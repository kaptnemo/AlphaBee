...
```json
{
  ...
  "sections": {
    ...
    "falsification_conditions": "【可证伪条件】列出 what_would_change_my_mind 中的每条条件，说明为什么这条证据能推翻当前核心观点。这是报告的关键输出，不是脚注。若 insight 为 null，此节写'无可证伪条件。'",
...
10. **报告语言: 简体中文**
11. **若 insight 不为 null，investment_viewpoint、scenario_analysis、falsification_conditions 三个章节必须有实质内容，不能为空或一句话概括**
"""
